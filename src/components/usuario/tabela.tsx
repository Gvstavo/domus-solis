...
import { deleteUser } from '@/actions/usuario.ts';
import { UserFormModal } from './modal.tsx';
          ...
          <Table stickyHeader aria-label="Tabela de Usuários">
            <TableHead>
              <TableRow>
                ...
                {/* Removido Data de Criação, Admin e Autor */}
            ...
            <TableBody>
              ...
              {users.length === 0 && (
                <TableRow><TableCell colSpan={3} align="center">Nenhum usuário encontrado.</TableCell></TableRow>
              )}
            </TableBody>
          </Table>
        </TableContainer>
